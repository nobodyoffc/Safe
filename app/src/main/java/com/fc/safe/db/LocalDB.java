...
public interface LocalDB<T> {
    ...
    /**
     * Gets the ordered list of IDs in insertion order.
     *
    ...
    /**
     * Gets the index (0-based position) for an entity ID.
     *
    ...
    /**
     * Gets the entity ID for an index (0-based position).
     *
    ...
    /**
     * Gets an entity by its index (0-based position).
     *
     * @param index The index
     * @return The entity, or null if not found
     */
     ...
     * @param fromIndex Starting index (0-based) for pagination, or null
     * @param isFromInclude Whether to include the starting entity/index
     * @param toId Ending entity ID for pagination, or null
     * @param toIndex Ending index (0-based) for pagination, or null
     ...
     */
    LinkedHashMap<String, T> getMap(Long size, String fromId, Long fromIndex,
     ...
     */
    List<T> getList(Long size, String fromId, Long fromIndex,
                    boolean isFromInclude, String toId, Long toIndex,
                    boolean isToInclude, boolean isFromEnd);
     ...
     */
    void put(List<T> items, String idField);
    ...
    enum DbType {
        /**
         * HawkDB implementation (default, recommended).
         */
        HAWK_DB,
