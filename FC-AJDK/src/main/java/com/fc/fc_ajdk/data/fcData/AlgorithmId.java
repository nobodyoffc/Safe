...
public enum AlgorithmId {
    ...
    FC_EccK1AesCbc256_No1_NrC7(Constants.ECC_K_1_AES_256_CBC_NO_1_NR_C_7), //Recommended for pubkey encryption.
    FC_AesCbc256_No1_NrC7(Constants.FC_AES_CBC_256_NO_1_NR_C_7),        //Recommended for symkey or password
    FC_Sha256SymSignMsg_No1_NrC7(Constants.FC_SHA256SYM_SIGNMSG_NO1_NRC7), //Recommended for symkey signature
    ...
    BitCore_EccAes256(Constants.ECC_256_K_1_AES_256_CBC), //The earliest Algorithm used in Bitcoin ecosystem which is from the project of bitcore by Bitpay. It is the same as EccAes256BitPay@No1_NrC7.
    BTC_EcdsaSignMsg_No1_NrC7(Constants.BTC_ECDSA_SIGNMSG_NO1_NRC7), //Wildly Used by Bitcoin ecosystem.
    ...
    EccAes256K1P7_No1_NrC7(Constants.ECC_AES_256_K_1_P_7_NO_1_NR_C_7) //Earlier version. Not recommended.
    ;
