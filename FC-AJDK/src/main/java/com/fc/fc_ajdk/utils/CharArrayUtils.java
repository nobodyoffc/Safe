...
public class CharArrayUtils {
    public static void main(String[] args) {
        ...
        System.out.println("The 32 bytes key in hex: " + bytesToHex(keyBytes));

        //输入utf8编码的普通密码
        ask = "Input a password in UTF8: ";
        char[] passwordCharArray = inputPassword(br, ask);
        byte[] passwordBytes = BytesUtils.charArrayToByteArray(passwordCharArray, StandardCharsets.UTF_8);
        System.out.println("The password in hex: " + bytesToHex(passwordBytes));
        ...
        System.out.println("The filled byte array: " + bytesToHex(keyBytes));
    }
